...
public class GenerateStudentTestData {
    ...
    public static void main(String[] args) {
        ...
        // Define the path to the students.txt file within the
        // directory
        String filePath = targetDirPath + File.separator + "testStudents.txt";

        // Generate student data and save it to the specified file
        generateStudentDataFile(filePath, 30);
    }
}